...
export const DesktopSidebar = ({
  ...
  return (
    <motion.div
      className={cn(
        'hidden h-full w-[300px] shrink-0 flex-col border-r border-border bg-sidebar px-4 py-4 md:flex',
        className
      )}
      animate={{
...
export const MobileSidebar = ({
  ...
  return (
    <>
      <div
        className={cn(
          'flex h-10 w-full flex-row items-center justify-between bg-sidebar px-4 py-4 md:hidden'
        )}
        {...props}
      >
